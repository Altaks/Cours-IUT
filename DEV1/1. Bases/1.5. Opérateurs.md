...
Il existe de nombreux opérateurs en C++. Des opérateurs dits unaires (une seule valeur), des opérateurs communs au mathématiques *exemple :* `+, -, /, \*, %`, ou encore des opérateurs [[2.3. La surcharge de fonction|surchargés]] qui ont un comportement qui a été réécrit par un développeur.
